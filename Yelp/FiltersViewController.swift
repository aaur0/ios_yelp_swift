...
class FiltersViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, FiltersCellDelegate {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell{
        let cell = tableView.dequeueReusableCellWithIdentifier("FiltersCell", forIndexPath: indexPath) as! FiltersCell
        cell.filterLabel.text = categories[indexPath.row]["name"]
        cell.delegate = self
        cell.optionSwitch.on = switchStates[indexPath.row] ?? false
